...
void APCharacter::MoveRight(float Value) {
	...
	// X = forward (Right in front of the char)
	// Y = Right (The right side of the char)
	// Z = Up (from the head of the char)
...
void APCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("PrimaryAttack", IE_Pressed, this, &APCharacter::PrimaryAttack);
